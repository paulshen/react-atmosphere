...
Because of the low-level nature of millefeuille, many accessibility features
need to be implemented in user space. millefeuille tries to handle as many a11y
features as it can.
