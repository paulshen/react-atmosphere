...
You will almost certainly want to customize tooltips, especially the
`renderTooltip` function. This is done via React Context.
...
The second arg to `renderTooltip` is Popper.js
[`State`](https://github.com/popperjs/popper-core/blob/1c380a42cccc5286786bcd73872f2f5157a99db8/src/types.js#L54-L77),
with gives you the tooltip placement and more. This is useful if you are
